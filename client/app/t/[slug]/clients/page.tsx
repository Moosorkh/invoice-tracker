...
interface Client {
  ...
  state?: string;
  status?: string;
  portalUsers?: { id: string; email: string; status: string }[];
}
...
export default function Clients() {
  ...
  const handleSubmit = async () => {
    setError("");
    try {
      const response = await fetch(`/t/${slug}/api/clients`, {
        method: "POST",
        headers: {
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await fetch(`/t/${slug}/api/clients/${currentClient.id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleOpenPortalDialog = async (client: Client) => {
    try {
      const res = await fetch(`/t/${slug}/api/clients/${client.id}/portal-users`, {
  ...
  const handleCreatePortalUser = async () => {
    ...
    try {
      const endpoint = useDirectPassword 
        ? `/t/${slug}/api/clients/${portalDialog.clientId}/portal-user/direct`
        : `/t/${slug}/api/clients/${portalDialog.clientId}/portal-user/invite`;
  ...
  const handleDirectPasswordReset = async () => {
    ...
    try {
      const res = await fetch(
        `/t/${slug}/api/clients/${portalDialog.clientId}/portal-users/${resetPasswordDialog.userId}/reset-password/direct`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleSendResetLink = async () => {
    ...
    try {
      const res = await fetch(`/t/${slug}/api/clients/${portalDialog.clientId}/portal-users/${resetPasswordDialog.userId}/reset-password`, {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleDeletePortalUser = async (portalUserId: string) => {
    ...
    try {
      await fetch(`/t/${slug}/api/clients/${portalDialog.clientId}/portal-users/${portalUserId}`, {
        method: "DELETE",
        headers: { Authorization: `Bearer ${token}` },
      });
      handleOpenPortalDialog({ id: portalDialog.clientId, name: portalDialog.clientName, email: "" });
            ...
            <>
              ...
              <MuiTableContainer>
                <Table size="small">
                  ...
                  <TableBody>
                    {portalDialog.portalUsers.map((pu: any) => (
                      <TableRow key={pu.id}>
